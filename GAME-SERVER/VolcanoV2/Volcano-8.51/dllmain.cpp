...
DWORD Main(LPVOID)
{
    ...
    ((UKismetSystemLibrary*)UKismetSystemLibrary::StaticClass()->DefaultObject)->ExecuteConsoleCommand(static_cast<SDK::UObject*>(GetWorld()), L"open Athena_Terrain", nullptr);

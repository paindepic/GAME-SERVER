...
void ServerAcknowledgePossessionHook(AFortPlayerController *PC, APawn *P) {
  ...
  auto FortPawn = (AFortPlayerPawn *)PC->MyFortPawn;
...
void ServerReadyToStartMatchHook(AFortPlayerController *PC) {
  if (PC) {
    ...
    Inventory::AddItem(PC,
                       test.Pickaxe ? test.Pickaxe->WeaponDefinition
                                    : YAYA->WeaponDefinition,
                       1);
    /*
    static auto PUMP =
    UObject::FindObject<UFortItemDefinition>("WID_Shotgun_Standard_Athena_UC_Ore_T03.WID_Shotgun_Standard_Athena_UC_Ore_T03");
    static auto AR =
    UObject::FindObject<UFortItemDefinition>("WID_Assault_Auto_Athena_R_Ore_T03.WID_Assault_Auto_Athena_R_Ore_T03");
    static auto Grap =
    UObject::FindObject<UFortItemDefinition>("WID_Hook_Gun_VR_Ore_T03.WID_Hook_Gun_VR_Ore_T03");

    static auto aaa =
    UObject::FindObject<UFortItemDefinition>("WID_Sniper_Heavy_Athena_VR_Ore_T03.WID_Sniper_Heavy_Athena_VR_Ore_T03");
    static auto DRUMGUN =
    UObject::FindObject<UFortItemDefinition>("WID_Assault_AutoDrum_Athena_R_Ore_T03.WID_Assault_AutoDrum_Athena_R_Ore_T03");
    static auto bbbc =
    UObject::FindObject<UFortItemDefinition>("WID_Pistol_Flintlock_Athena_UC.WID_Pistol_Flintlock_Athena_UC");
    ...
    Inventory::AddItem(PC,
    ((UFortWeaponItemDefinition*)aaa)->GetAmmoWorldItemDefinition_BP(), 9999);
    Inventory::AddItem(PC,
    ((UFortWeaponItemDefinition*)DRUMGUN)->GetAmmoWorldItemDefinition_BP(),
    9999); Inventory::AddItem(PC,
    ((UFortWeaponItemDefinition*)AR)->GetAmmoWorldItemDefinition_BP(), 9999);
    Inventory::AddItem(PC,
    ((UFortWeaponItemDefinition*)PUMP)->GetAmmoWorldItemDefinition_BP(), 9999);
    ...
    if (!bTest) {
      ...
      // AFortPlayerController::OnReadyToStartMatch: Marking player
      // MCP:<Redacted> ready to start ^ heres where this stuff stops, gamemode
      // doesn't return true at ReadyToStartMatch, no idea why yet
    }
  }
...
static bool (*CantBuild)(SDK::UWorld *, SDK::UObject *, FVector, FRotator, char,
                         void *, char *) =
    decltype(CantBuild)(GetOffsetBRUH(0x1330D70)); // 0x1330D70
void ServerCreateBuildingActorHook(
  ...
  if (!CantBuild(GetWorld(), Class, CreateBuildingData.BuildLoc,
    ...
    if (auto NewBuilding = SpawnActor<ABuildingSMActor>(
...
static ABuildingSMActor *(*ReplaceBuildingActorOG)(
    ABuildingSMActor *, char, UClass *, int, uint8, bool,
    AController *) = decltype(ReplaceBuildingActorOG)(GetOffsetBRUH(0x11252B0));
void ServerEditBuildingActorHook(AFortPlayerController *PC,
                                 ABuildingSMActor *BuildingActorToEdit,
                                 UClass *NewBuildingClass,
                                 uint8 RotationIterations, bool bMirrored) {
  if (PC && BuildingActorToEdit && NewBuildingClass) {
    if (auto NewBuilding =
            ReplaceBuildingActorOG(BuildingActorToEdit, 1, NewBuildingClass,
                                   BuildingActorToEdit->CurrentBuildingLevel,
                                   RotationIterations, bMirrored, PC)) {
      NewBuilding->bPlayerPlaced = true;
...
// Test: 0x16E2230
void (*GetPlayerViewPointOG)(AFortPlayerController *a1, FVector a2,
                             FRotator a3);
  ...
  if (a1->WorldInventory) {
    ...
    for (int i = 0; i < InstancesPtr->Num(); i++) {
      if (InstancesPtr->operator[](i)) {
        if (((UFortWorldItemDefinition *)InstancesPtr->operator[](i)
                 ->ItemEntry.ItemDefinition)
                ->bCanBeDropped) {
          LOG_("REAL 1");
          ToDropGoodSir.push_back(
              InstancesPtr->operator[](i)->ItemEntry.ItemGuid);
        }
      }
    }
    ...
    if (Globals::bLategame) {
      ...
      // Shotguns
      static auto Pump1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_Standard_Athena_UC_Ore_T03.WID_Shotgun_Standard_Athena_"
          "UC_Ore_T03");
      static auto Pump2 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_Standard_Athena_VR_Ore_T03.WID_Shotgun_Standard_Athena_"
          "VR_Ore_T03");
      static auto Pump3 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_Standard_Athena_SR_Ore_T03.WID_Shotgun_Standard_Athena_"
          "SR_Ore_T03");
      static auto TacShotty = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_SemiAuto_Athena_VR_Ore_T03.WID_Shotgun_SemiAuto_Athena_"
          "VR_Ore_T03");
      static auto DoubleBarel1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_BreakBarrel_Athena_VR_Ore_T03.WID_Shotgun_BreakBarrel_"
          "Athena_VR_Ore_T03");
      static auto DoubleBarel2 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_BreakBarrel_Athena_SR_Ore_T03.WID_Shotgun_BreakBarrel_"
          "Athena_SR_Ore_T03");
      static auto HeavyShotty1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_SlugFire_Athena_VR.WID_Shotgun_SlugFire_Athena_VR");
      static auto HeavyShotty2 = UObject::FindObject<UFortItemDefinition>(
          "WID_Shotgun_SlugFire_Athena_SR.WID_Shotgun_SlugFire_Athena_SR");

      // ARs / SMGs
      static auto AR1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_AutoHigh_Athena_VR_Ore_T03.WID_Assault_AutoHigh_Athena_"
          "VR_Ore_T03");
      static auto AR2 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_AutoHigh_Athena_SR_Ore_T03.WID_Assault_AutoHigh_Athena_"
          "SR_Ore_T03");
      static auto AR3 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_Auto_Athena_R_Ore_T03.WID_Assault_Auto_Athena_R_Ore_"
          "T03"); // blue but fr ts time yo
      static auto DrumGun1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_AutoDrum_Athena_R_Ore_T03.WID_Assault_AutoDrum_Athena_R_"
          "Ore_T03");
      static auto DrumGun2 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_AutoDrum_Athena_UC_Ore_T03.WID_Assault_AutoDrum_Athena_"
          "UC_Ore_T03");
      static auto AK1 = UObject::FindObject<UFortItemDefinition>(
          "WID_Assault_Heavy_Athena_R_Ore_T03.WID_Assault_Heavy_Athena_R_Ore_"
          "T03");

      // Utils / Snipers
      static auto Sniper = UObject::FindObject<UFortItemDefinition>(
          "WID_Sniper_Heavy_Athena_VR_Ore_T03.WID_Sniper_Heavy_Athena_VR_Ore_"
          "T03");
      static auto InfGrappler = UObject::FindObject<UFortItemDefinition>(
          "WID_Hook_Gun_Slide.WID_Hook_Gun_Slide");
      // static auto Grappler =
      // UObject::FindObject<UFortItemDefinition>("WID_Hook_Gun_VR_Ore_T03.WID_Hook_Gun_VR_Ore_T03");
      static auto FlintKnock = UObject::FindObject<UFortItemDefinition>(
          "WID_Pistol_Flintlock_Athena_UC.WID_Pistol_Flintlock_Athena_UC");
      static auto BoomBow = UObject::FindObject<UFortItemDefinition>(
          "WID_ExplosiveBow_Athena_VR_SR.WID_ExplosiveBow_Athena_VR_SR");

      // Consumables
      static auto BigShield = UObject::FindObject<UFortItemDefinition>(
          "Athena_Shields.Athena_Shields");
      static auto Minis = UObject::FindObject<UFortItemDefinition>(
          "Athena_ShieldSmall.Athena_ShieldSmall");
      static auto Medkit = UObject::FindObject<UFortItemDefinition>(
          "Athena_Medkit.Athena_Medkit");
      static auto Slurp = UObject::FindObject<UFortItemDefinition>(
          "Athena_PurpleStuff.Athena_PurpleStuff");

      // Materials
      static auto Wood =
          UObject::FindObject<UFortItemDefinition>("WoodItemData.WoodItemData");
      static auto Brick = UObject::FindObject<UFortItemDefinition>(
          "StoneItemData.StoneItemData");
      static auto Metal = UObject::FindObject<UFortItemDefinition>(
          "MetalItemData.MetalItemData");

      // === Categorize pools ===
      std::vector<UFortItemDefinition *> Shotguns = {
          Pump1,        Pump2,        Pump3,        TacShotty,
          DoubleBarel1, DoubleBarel2, HeavyShotty1, HeavyShotty2};
      std::vector<UFortItemDefinition *> ARsSMGs = {AR1,      AR2,      AR3,
                                                    DrumGun1, DrumGun2, AK1};
      std::vector<UFortItemDefinition *> SnipersOrUtility = {
          Sniper, InfGrappler, BoomBow, /*Grappler,*/ FlintKnock};
      std::vector<UFortItemDefinition *> Heals = {BigShield, Minis, Medkit,
                                                  Slurp};
      ...
      // Random picker
      auto Pick = [](std::vector<UFortItemDefinition *> &pool)
          -> UFortItemDefinition * {
        if (pool.empty())
          return nullptr;
      ...
      if (Shotgun) {
        int ammo = 5;
        if (Shotgun == TacShotty)
          ammo = 8;
        if (Shotgun == DoubleBarel1 || Shotgun == DoubleBarel2)
          ammo = 2;
        if (Shotgun == HeavyShotty1 || Shotgun == HeavyShotty2)
          ammo = 7;
      ...
      if (ARSMG) {
        int ammo = 30;
        if (ARSMG == DrumGun1 || ARSMG == DrumGun2)
          ammo = 50;
        if (ARSMG == AK1)
          ammo = 25;
      ...
      if (Heal1)
        Inventory::AddItem(a1, Heal1, GetHealCount(Heal1));
      if (Heal2)
        Inventory::AddItem(a1, Heal2, GetHealCount(Heal2));
      ...
      // --- Give Materials ---
      if (Wood)
        Inventory::AddItem(a1, Wood, 500);
      if (Brick)
        Inventory::AddItem(a1, Brick, 250);
      if (Metal)
        Inventory::AddItem(a1, Metal, 125);
    }
  }
...
static void (*RemoveFromAlivePlayerOG)(void *, void *, void *, void *, void *,
                                       EDeathCause, char) =
    decltype(RemoveFromAlivePlayerOG)(GetOffsetBRUH(0xFAE8C0));
void (*ClientOnPawnDiedOG)(AFortPlayerControllerZone *a1,
...
void ClientOnPawnDiedHook(AFortPlayerControllerZone *DeadPlayer,
  ...
  auto KillerPlayerState =
      (AFortPlayerStateAthena *)DeathReport.KillerPlayerState;
  ...
  EDeathCause DeathCause =
      DeadPlayerState->ToDeathCause(DeathReport.Tags, DeadPawn->bIsDBNO);
  ...
  DeadPlayerState->DeathInfo.FinisherOrDowner =
      KillerPlayerState ? KillerPlayerState : DeadPlayerState;
  DeadPlayerState->DeathInfo.Distance =
      DeathCause == EDeathCause::FallDamage
          ? DeadPawn->LastFallDistance
          : DeadPawn->GetDistanceTo(KillerPawn);
  DeadPlayerState->DeathInfo.DeathLocation =
      DeadPawn ? DeadPawn->K2_GetActorLocation() : FVector{};
  ...
  if (!GetGameState()->IsRespawningAllowed(DeadPlayerState)) {
    if (!DeadPawn->IsDBNO()) {
      if (DeadPlayer->WorldInventory) {
        for (int i = 0;
             i < DeadPlayer->WorldInventory->Inventory.ItemInstances.Num();
             i++) {
          if (DeadPlayer->WorldInventory->Inventory.ItemInstances[i]
                  ->CanBeDropped()) {
            SpawnPickup(DeadPlayer->WorldInventory->Inventory.ItemInstances[i]
                            ->ItemEntry,
                        DeadPawn->K2_GetActorLocation(),
...
void (*ServerAttemptInteractOG)(UFortControllerComponent_Interaction *Comp,
                                AActor *ReceivingActor,
                                UPrimitiveComponent *InteractComponent,
                                ETInteractionType InteractType, __int64);
void ServerAttemptInteractHook(UFortControllerComponent_Interaction *Comp,
                               AActor *ReceivingActor,
                               UPrimitiveComponent *InteractComponent,
  ...
  if (PC) {
    if (auto Container = Cast<ABuildingContainer>(ReceivingActor)) {
      ...
      /*FVector aa;
      FVector bbb;
      Container->StartBounceAnimation(0, 0, aa, bbb, EFortBounceType::Interact,
      false);*/

      FVector Loc = Container->K2_GetActorLocation() +
                    (Container->GetActorRightVector() * 44);
      Loc.Z += 24;
      ...
      if (ClassName.contains("Chest")) {
        ...
        auto Ammo = ((UFortWeaponItemDefinition *)Weapon->ItemDefinition)
                        ->GetAmmoWorldItemDefinition_BP();
      ...
      for (auto &LootItem : LOOT) {
        SpawnPickup(LootItem->ItemDefinition, LootItem->DropCount,
                    LootItem->LoadedAmmo, Loc,
  ...
  return ServerAttemptInteractOG(Comp, ReceivingActor, InteractComponent,
                                 InteractType,
                                 ssss); // theres more stuff in the params but I
                                        // cba cuz unreflected elements
}
...
//         // no need to set Rotation + this is so bad I want it so I can start
//         safeZones phase before players jump
//
//         auto NewPawn = GetGameMode()->SpawnDefaultPawnAtTransform(PC,
//         SpawnTransform); PC->Possess(NewPawn);
//
//         return;
//     }
//
...
void InitHoksPC() {
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x108,
              ServerAcknowledgePossessionHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x1FD,
              ServerExecuteInventoryItem);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x223,
              ServerCreateBuildingActorHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x22A,
              ServerBeginEditingBuildingActorHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x225,
              ServerEditBuildingActorHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x228,
              ServerEndEditingBuildingActorHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x1BC,
              ServerPlayEmoteItemHook);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x25F,
              ServerReadyToStartMatchHook, (void **)&ServerReadyToStartMatchOG);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x458,
              ServerClientIsReadyToRespawn);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x210,
              ServerAttemptInventoryDropHook);
  VirtualHook(GetDefObj<UFortControllerComponent_Interaction>(), 0x80,
              ServerAttemptInteractHook, (void **)&ServerAttemptInteractOG);
  VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x420, ServerSetTeamHook,
              (void **)&ServerSetTeam);
  // VirtualHook(GetDefObj<AAthena_PlayerController_C>(), 0x433,
  // ServerAttemptAircraftJump, (void**)&ServerAttemptAircraftJumpOG);

  MH_CreateHook((LPVOID)GetOffsetBRUH(0x1003280), ExitAircraftHook,
                (void **)&ExitAircraft);
  MH_EnableHook((LPVOID)GetOffsetBRUH(0x1003280));

  MH_CreateHook((LPVOID)GetOffsetBRUH(0x10020E0), EnterAircraftHook,
                (void **)&EnterAircraft);
  MH_EnableHook((LPVOID)GetOffsetBRUH(0x10020E0));

  MH_CreateHook((LPVOID)GetOffsetBRUH(0x16E2230), GetPlayerViewPointHook,
                (void **)&GetPlayerViewPointOG);
  MH_EnableHook((LPVOID)GetOffsetBRUH(0x16E2230));

  MH_CreateHook((LPVOID)GetOffsetBRUH(0x1AEC9A0), ClientOnPawnDiedHook,
                (void **)&ClientOnPawnDiedOG);
